...
const skills = {
  ...
  "Monitoring & Debugging": ["Splunk", "AppDynamics", "Dynatrace", "Datadog", "Prometheus", "Log Analysis", "Root Cause Analysis"],
        ...
        <div className="grid gap-10 py-14 md:grid-cols-12 md:items-center">
          <div className="md:col-span-7">
            ...
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-neutral-600">
              Software Engineer with 5+ years of experience across performance engineering, test automation, root cause
              analysis, and compliance-aligned development. Built and validated enterprise banking platforms at scale,
              strengthened release confidence through CI/CD-integrated testing, and delivered measurable reliability and
    ...
    +1 909-380-6984
              ...
              <div className="mt-6 rounded-2xl bg-neutral-900 p-5 text-white">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/90">
                  I’m a Software Engineer in Test with 5+ years of experience in performance engineering and quality-driven delivery.
